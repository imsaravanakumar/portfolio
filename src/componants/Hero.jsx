        ...
        <section id='hero' className='flex flex-col lg:flex-row  py-40 bg  md:justify-center overflow-hidden'>
            <div className='herotext w-full lg:w-1/2 text-white text-center lg:text-start'>
                ...
                bg-clip-text text-transparent mt-5 shadow-current'>{hero.heroname} </h1>
                    ...
                    <button className='hidden lg:block py-3 px-6 font-medium shadow-btn custom-shadow my-6'><a href="https://drive.google.com/file/d/1nifjxDn70afVpLpyYmlvKlXjnnJwTp3g/view?usp=drivesdk">Download CV</a></button>
                </div>               
            </div>
            ...
            <button className='block lg:hidden w-1/2 py-3 px-6  my-6 mx-auto font-medium text-nowrap text-white shadow-btn custom-shadow'><a href="https://drive.google.com/file/d/1nifjxDn70afVpLpyYmlvKlXjnnJwTp3g/view?usp=drivesdk">Download CV</a> </button>
        </section>
    )
}